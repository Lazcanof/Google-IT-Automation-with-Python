...
def main(argv):
  ...
  data = load_data("/home/student-02-f31bbacb1765/car_sales.json")
  ...
  msg = email_generate("automation@example.com", "student-02-f31bbacb1765@example.com", "Sales summary for last month", new_summary, "/tmp/cars.pdf")
  email_send(msg)
